    ...
    return (
        <>
            <Row gutter={[20,25]}>
                ...
                <Col xxl={16} xl={16} lg={16} md={24} sm={24} xs={24}><div className='col box-5'>Box 5</div></Col>
                <Col xxl={8} xl={8} lg={8} md={24} sm={24} xs={24}><div className='col box-6'>Box 6</div></Col>
